...
## Contexto
- App de Kath Guedes (atleta Bikini, 351K seguidores). Stack: Next.js 15 (App Router) + TypeScript + Tailwind v4 + shadcn/ui + Supabase Postgres + Clerk (auth) + Asaas (pagamentos) + Vercel + Sentry. PWA dark always-on.
