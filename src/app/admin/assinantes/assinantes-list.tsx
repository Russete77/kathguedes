...
const TIER_OPTIONS: { value: PlanTier; label: string }[] = [
  { value: "start", label: "Start · R$39,90" },
  { value: "evolucao", label: "Evolução · R$74,90" },
  { value: "saude_completa", label: "Saúde Completa · R$99,90" },
...
const FILTER_TIERS: ("all" | PlanTier)[] = [
  "all", "start", "evolucao", "saude_completa", "atleta",
];
