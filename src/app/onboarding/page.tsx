...
// Onboarding é sempre autenticado (Clerk middleware redireciona logout) e lê
// `redirect_url` do client. Pular prerender estático evita erro de SSR com
// useSearchParams e mantém o comportamento dinâmico esperado.
  ...
  return (
    <div className="min-h-screen bg-bg-base flex items-center justify-center px-4 py-10">
      <div className="max-w-lg w-full space-y-8">
        ...
        <Suspense fallback={<div className="text-gray-3 text-sm text-center">Carregando…</div>}>
          <OnboardingForm />
        </Suspense>
      </div>
    </div>
