...
export const metadata: Metadata = {
  ...
  description: "Cupons de desconto exclusivos negociados pela Kath com marcas parceiras de fitness e lifestyle. Só para assinantes KathApp.",
  alternates: { canonical: "https://www.kathguedes.com.br/cupons" },
};
